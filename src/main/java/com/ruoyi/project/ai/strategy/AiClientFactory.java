...
import com.ruoyi.project.ai.strategy.impl.DoubaoSdkClientStrategy;
...
public class AiClientFactory {
    ...
    public static AiClientStrategy fromConfig(AiModelConfig cfg) {
        ...
        // 豆包优先使用 SDK 策略（chat、image）
        if ("doubao".equalsIgnoreCase(provider)) {
            return new DoubaoSdkClientStrategy(apiKey, endpoint, model, model);
        }
